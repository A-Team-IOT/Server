...
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function lightTemplate(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {var pug_debug_sources = {"views\u002Fclient\u002Flight.pug":"mixin light(comp)\r\n    if (comp.props.state == \"1\")\r\n        img(id=comp.id).onBulb(src=\"\u002Fviews\u002Fimages\u002FbulbOn1.png\" alt=\"Bulb On Image\")\r\n    else\r\n        img(id=comp.id).offBulb(src=\"\u002Fviews\u002Fimages\u002FbulbOff.png\" alt=\"Bulb Off Image\")\r\n    br\r\n    p #{comp.name}"};
;pug_debug_line = 1;pug_debug_filename = "views\u002Fclient\u002Flight.pug";
